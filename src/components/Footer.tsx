...
const Footer = () => {
  return <footer className="border-t border-border/30 bg-gradient-to-b from-card to-background relative overflow-hidden">
      {/* Animated gold line */}
      <motion.div className="absolute top-0 left-0 h-0.5 bg-gradient-gold" initial={{
      width: 0
    }} whileInView={{
      width: "100%"
    }} viewport={{
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          delay: 0.1
            ...
            <ul className="space-y-3">
              ...
              path: "/contact"
                  ...
                  <Link to={link.path} className="text-sm text-muted-foreground hover:text-primary transition-colors font-body group">
          ...
          delay: 0.2
            ...
            <ul className="space-y-3">
              {["On-Ramp Solutions", "Off-Ramp Services", "Digital Asset Custody", "Liquidity Infrastructure"].map(service => <li key={service} className="text-sm text-muted-foreground font-body">
                  {service}
                </li>)}
            </ul>
          </motion.div>
        ...
        <motion.div className="mt-16 pt-8 border-t border-border/30" initial={{
        opacity: 0
      }} whileInView={{
        opacity: 1
      }} viewport={{
        ...
        delay: 0.4
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            ...
            <div className="text-center md:text-left">
              <motion.p className="text-lg font-heading font-semibold mb-2" animate={{
              textShadow: ["0 0 10px rgba(253, 198, 57, 0.3)", "0 0 20px rgba(253, 198, 57, 0.5)", "0 0 10px rgba(253, 198, 57, 0.3)"]
            }} transition={{
              duration: 3,
              repeat: Infinity
            }}>
              ...
              <motion.div className="h-0.5 bg-gradient-gold rounded-full" initial={{
              scaleX: 0
            }} animate={{
              scaleX: 1
            }} transition={{
